...
$$ pid is the current shell(not subshell)
$_ most recent paramenter(or the abs path of the command to start the current shell immediately after start up)
...
# for a better document, here: http://tldp.org/LDP/Bash-Beginners-Guide/html/sect_07_01.html
-a file                   # file exists
-b file                   # true if file exits and is a block-special file.
