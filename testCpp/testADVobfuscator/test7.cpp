...
int main(){
    /* don't really need to random header file */
#if 0
    std::cout<<MetaRandomGenerator<0>::value<<std::endl;
    std::cout<<MetaRandomGenerator<1>::value<<std::endl;
    std::cout<<MetaRandomGenerator<2>::value<<std::endl;
    std::cout<<MetaRandomGenerator<3>::value<<std::endl;
    std::cout<<MetaRandomGenerator<4>::value<<std::endl;
    std::cout<<MetaRandomGenerator<5>::value<<std::endl;
    std::cout<<MetaRandomGenerator<6>::value<<std::endl;
    std::cout<< MetaRandom<1, 5>::value <<std::endl;
    std::cout<< MetaRandom<1, 5>::value <<std::endl;
    std::cout<< MetaRandom<1, 5>::value <<std::endl;
    std::cout<< MetaRandom<1, 5>::value <<std::endl;
#endif
