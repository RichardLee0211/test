...
## from: https://raw.githubusercontent.com/BookStackApp/devops/main/scripts/installation-ubuntu-22.04.sh
...
function run_package_installs() {
  ...
  apt install -y dolphin
    # apache2 php8.1 php8.1-curl php8.1-mbstring php8.1-ldap \
...
## wen: good place to learn, short config file could put in here
##   long config file could pull from github public repo
## cat << EOL
